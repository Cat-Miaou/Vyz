...
academie_paris <- academie_graph +
  ...
  plot_annotation(
    ...
    theme = theme(
      plot.title = element_text(size = 30, face = "bold", margin = margin(t = 0, b = 0)),  # Titre principal
      plot.subtitle = element_text(size = 25, hjust = 0, vjust= 0),             # Sous-titre
...
grid.segments(
  x0 = unit(0.251, "npc"), y0 = unit(0.67, "npc"),   # Point de départ (dans academie_graph)
  x1 = unit(0.470, "npc"), y1 = unit(0.627, "npc"),   # Point d'arrivée (dans paris_graph)
  gp = gpar(col = "black", lwd = 1.6, lty = "solid"))

grid.segments(
  x0 = unit(0.251, "npc"), y0 = unit(0.67, "npc"),   # Point de départ (dans academie_graph)
  x1 = unit(0.470, "npc"), y1 = unit(0.336, "npc"),   # Point d'arrivée (dans paris_graph)
  gp = gpar(col = "black", lwd = 1.6, lty = "solid"))

grid.segments(
  x0 = unit(0.251, "npc"), y0 = unit(0.67, "npc"),   # Point de départ (dans academie_graph)
  x1 = unit(0.757, "npc"), y1 = unit(0.627, "npc"),   # Point d'arrivée (dans paris_graph)
  gp = gpar(col = "black", lwd = 1.6, lty = "solid"))
