...
ggplot() +
  ...
  annotate("segment", x = 2015, xend = 2016.95, y = 0.6, yend = 0.7, 
           arrow = arrow(length = unit(0.2, "cm")), color = "#666666") +
  annotate("segment", x = 2012.5, xend = 2013.05, y = 0.45, yend = 0.58, 
           arrow = arrow(length = unit(0.2, "cm")), color = "#666666") +
  annotate("segment", x = 2018.5, xend = 2018.05, y = 0.42, yend = 0.62, 
           arrow = arrow(length = unit(0.2, "cm")), color = "#666666") +
  # Mise en place des labels pour 2011, 2017 et 2018
  geom_label(aes(x = 2008.5, y = 0.58, label = "Histoire des arts"), color = "#666666", fill = "white", size = 8, label.size = 0.5, label.padding = unit(0.3, "lines")) +
  geom_label(aes(x = 2015, y = 0.58, label = "Mise en place \ndu contrôle continu"), color = "#666666", fill = "white", size = 8, label.size = 0.5, label.padding = unit(0.3, "lines")) +
  geom_label(aes(x = 2012.5, y = 0.43, label = "2 séries : générale et \nprofessionnelle"), color = "#666666", fill = "white", size = 8, label.size = 0.5, label.padding = unit(0.3, "lines")) +
  geom_label(aes(x = 2018.5, y = 0.4, label = " Épreuves finales \nplus importantes"), color = "#666666", fill = "white", size = 8, label.size = 0.5, label.padding = unit(0.3, "lines")) +  # Configuration de l'axe Y et des labels
